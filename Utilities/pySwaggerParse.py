...
parser = SwaggerParser(swagger_path='http://vapp31.atlqa1:19811/setting/swagger-ui.html#/')  # Init with file
parser = SwaggerParser(swagger_dict={})  # Init with dictionary

"""
# Get an example of dict for the definition Foo
parser.definitions_example.get('bounce-settings-controller')
